...
export const VendorDashboard: React.FC<VendorDashboardProps> = ({
  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-28 md:pb-28">
      ...
      <div className="fixed bottom-0 sm:bottom-4 inset-x-0 z-50 bg-white border border-slate-200 py-2 px-4 flex items-center justify-around w-full max-w-md mx-auto shadow-2xl rounded-t-2xl sm:rounded-2xl">
        <button
