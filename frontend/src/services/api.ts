...
export const mockLendersList: Lender[] = [
  {
    ...
    logoUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="20" fill="%23003893"/><text x="50" y="62" font-family="Arial, sans-serif" font-size="38" font-weight="bold" fill="%23FFFFFF" text-anchor="middle">NF</text></svg>',
    ...
    email: 'contact@nishanthfinance.com',
  ...
  },
  {
    ...
    logoUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="20" fill="%23059669"/><text x="50" y="62" font-family="Arial, sans-serif" font-size="38" font-weight="bold" fill="%23FFFFFF" text-anchor="middle">RF</text></svg>',
    ...
    email: 'contact@rajeshfinance.com',
    whatsAppUrl: 'https://wa.me/919833344556',
  },
  {
    id: 'l3',
    institutionName: 'Suresh Finance',
    institutionType: 'Financial Institution',
    logoUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="20" fill="%237C3AED"/><text x="50" y="62" font-family="Arial, sans-serif" font-size="38" font-weight="bold" fill="%23FFFFFF" text-anchor="middle">SF</text></svg>',
    ...
    email: 'contact@sureshfinance.com',
    whatsAppUrl: 'https://wa.me/919811122334',
  },
  {
    id: 'l4',
    institutionName: 'Kishore Finance',
    institutionType: 'NBFC',
    logoUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="20" fill="%23D97706"/><text x="50" y="62" font-family="Arial, sans-serif" font-size="38" font-weight="bold" fill="%23FFFFFF" text-anchor="middle">KF</text></svg>',
    ...
    email: 'contact@kishorefinance.com',
    whatsAppUrl: 'https://wa.me/919844455667',
  },
  {
    id: 'l5',
    institutionName: 'Venkatesh Finance',
    institutionType: 'Financial Institution',
    logoUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="20" fill="%232563EB"/><text x="50" y="62" font-family="Arial, sans-serif" font-size="38" font-weight="bold" fill="%23FFFFFF" text-anchor="middle">VF</text></svg>',
    ...
    email: 'contact@venkateshfinance.com',
    whatsAppUrl: 'https://wa.me/919855566778',
  },
  {
    id: 'l6',
    institutionName: 'Ramesh Finance',
    institutionType: 'NBFC',
    logoUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="20" fill="%23DC2626"/><text x="50" y="62" font-family="Arial, sans-serif" font-size="38" font-weight="bold" fill="%23FFFFFF" text-anchor="middle">RF</text></svg>',
    ...
    email: 'contact@rameshfinance.com',
    whatsAppUrl: 'https://wa.me/919866677889',
  },
  {
    id: 'l7',
    institutionName: 'Mahesh Finance',
    institutionType: 'Financial Institution',
    logoUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" rx="20" fill="%234F46E5"/><text x="50" y="62" font-family="Arial, sans-serif" font-size="38" font-weight="bold" fill="%23FFFFFF" text-anchor="middle">MF</text></svg>',
    ...
    email: 'contact@maheshfinance.com',
